...
import 'package:flutter_web/usuario%203/repository3/firebase/user_docs_dialog.dart';
import 'package:flutter_web/usuario%203/web/authetic3.dart';
import 'package:flutter_web/utils/alert.dart';
import 'package:flutter_web/utils/alert3.dart';
import 'package:flutter_web/utils/loandig.dart';
import 'package:flutter_web/utils/masks.dart';
import 'package:intl/intl.dart';
import 'package:pattern_formatter/numeric_formatter.dart';

class listMobile4 extends StatefulWidget {
  final List<Usua> users;

  const listMobile4({super.key, required this.users});

  @override
  State<listMobile4> createState() => _listMobile4State();
}

class _listMobile4State extends State<listMobile4> {
  final statusValue = ValueNotifier('');
  final dropCategoria = ['Finalizado', 'Pendente'];
  AuthService3 authService3 = AuthService3();
                                                                                      ...
                                                                                      child: Column(
                                                                                        children: <Widget>[
                                                                                          Container(
                                                                                            ...
                                                                                            child: ListTile(
                                                                                              title: const Text("PROJETO BB", textAlign: TextAlign.left, style: TextStyle(color: Colors.white, fontSize: 10)),
                                                                                              leading: Radio(
                                                                                                  value: 'PROJETO BB',
                                                                                          ...
                                                                                          Container(
                                                                                            margin: const EdgeInsets.symmetric(horizontal: 5),
                                                                                            child: ListTile(
                                                                                              title: const Text("CCIR e ITR", textAlign: TextAlign.left, style: TextStyle(color: Colors.white, fontSize: 10)),
                                                                                              leading: Radio(
                                                                                                  value: 'CCIR e ITR',
                                                                                                  activeColor: const Color.fromARGB(255, 255, 255, 255),
                                                                                                  groupValue: radioValue,
                                                                                          ...
                                                                                          Container(
                                                                                            margin: const EdgeInsets.symmetric(horizontal: 5),
                                                                                            child: ListTile(
                                                                                              title: const Text("GEO", textAlign: TextAlign.left, style: TextStyle(color: Colors.white, fontSize: 10)),
                                                                                              leading: Radio(
                                                                                                  value: 'GEO',
                                                                                                  groupValue: radioValue,
                                                                                                  activeColor: const Color.fromARGB(255, 255, 255, 255),
                                                                                          ...
                                                                                          Container(
                                                                                              margin: const EdgeInsets.symmetric(horizontal: 5),
                                                                                              child: ListTile(
                                                                                                title: const Text("CAR/CEFIR", textAlign: TextAlign.left, style: TextStyle(color: Colors.white, fontSize: 10)),
                                                                                                leading: Radio(
                                                                                                    value: 'CAR/CEFIR',
                                                                                                    groupValue: radioValue,
                                                                                                    activeColor: const Color.fromARGB(255, 255, 255, 255),
                                                                              ...
                                                                              child: SizedBox(
                                                                                ...
                                                                                child: ElevatedButton(
                                                                                    onPressed: () async {
                                                                                      ...
                                                                                      await authService3.updateUser(newUser);
