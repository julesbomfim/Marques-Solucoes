...
class uploadMobile3 extends StatefulWidget {
  //final Usua user;
  const uploadMobile3({super.key, required this.user});
  final Usua user;

  @override
  State<uploadMobile3> createState() => _uploadMobile3State();
}

class _uploadMobile3State extends State<uploadMobile3> {
