...
import 'package:flutter_web/usuario%203/mobile/listTestMobile3.dart';
import 'package:flutter_web/usuario%203/web/authetic3.dart';
import 'package:shared_preferences/shared_preferences.dart';

class mobileVisualPage3 extends StatefulWidget {
  const mobileVisualPage3({super.key});

  @override
  State<mobileVisualPage3> createState() => _mobileVisualPage3State();
}

class _mobileVisualPage3State extends State<mobileVisualPage3> {
                            ...
                            builder: (context, snp) {
                              ...
                              if (snp.hasData) {
                                ...
                                return SizedBox(
                                    ...
                                    child: listMobile4(users: allusua));
                              } else {
                                return const Center(
