...
import 'package:flutter_web/usuario%203/mobile/uploadFileMobile3.dart';
...
class mobileCadastrarPage3 extends StatefulWidget {
  const mobileCadastrarPage3({super.key});

  @override
  State<mobileCadastrarPage3> createState() => _mobileCadastrarPage3State();
}

class _mobileCadastrarPage3State extends State<mobileCadastrarPage3> {
  ...
  AuthService3 authController3 = AuthService3();
  @override
          ...
          child: ListView(
            children: [
              ...
              ListTile(
                ...
                onTap: () {
                  ...
                  RouterManager.router
                      .navigateTo(context, '/visualPageMobile3');
                },
              ),
              ListTile(
                ...
                onTap: () {
                  RouterManager.router
                      .navigateTo(context, '/cadastrarPageMobile3');
                },
              ),
              ListTile(
              ...
              ListTile(
                ...
                onTap: () async {
                  await authController3.signOut(context);
                                  ...
                                  child: SizedBox(
                                    ...
                                    child: ElevatedButton(
                                        onPressed: () async {
                                          ...
                                          await authService3.addUser(user);
