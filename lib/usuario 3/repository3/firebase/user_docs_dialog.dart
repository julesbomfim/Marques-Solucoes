...
import 'package:flutter_web/usuario%203/controllers3/user-controller/user_controller.dart';
...
class UserDocsDialogBody3 extends StatefulWidget {
  final Usua user;

  const UserDocsDialogBody3({super.key, required this.user});

  @override
  State<UserDocsDialogBody3> createState() => _UserDocsDialogBody3State();
}

class _UserDocsDialogBody3State extends State<UserDocsDialogBody3> {
////// download
                      ...
                      (docName) => Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            IconButton(
                              onPressed: () async {
                                final userController = UserController3();
                                ...
                                final response =
                                    await userController.deleteUserDoc3(
                                  user: widget.user,
                                  fileName: docName,
                                );
        ...
        ElevatedButton(
            onPressed: selectedFiles.isEmpty
                ...
                : () async {
                    ...
                    final response = await userController.insertUserDocs3(
