...
import 'package:flutter_web/usuario%203/web/listTestWeb3.dart';
import 'package:shared_preferences/shared_preferences.dart';

class webVisualPage3 extends StatefulWidget {
  const webVisualPage3({super.key});

  @override
  State<webVisualPage3> createState() => _webVisualPage3State();
}

class _webVisualPage3State extends State<webVisualPage3> {
  ...
  final ValueNotifier<int> opcaoSelecionada = ValueNotifier<int>(0);
  @override
                    ...
                    Row(
                      children: <Widget>[
                        ...
                        TextButton(
                          ...
                          onPressed: () {
                            RouterManager.router
                                .navigateTo(context, '/visualPage3');
                          },
                          child: const Text(
                            'Página Inicial',
                            style: TextStyle(
                        ...
                        TextButton(
                          ...
                          onPressed: () {
                            RouterManager.router
                                .navigateTo(context, '/cadastrarPage3');
                          },
                          child: const Text(
                            'Cadastrar Clientes',
                            style: TextStyle(
