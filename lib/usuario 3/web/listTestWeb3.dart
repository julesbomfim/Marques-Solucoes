...
class listWeb3 extends StatefulWidget {
  final List<Usua> users;

  const listWeb3({super.key, required this.users});

  @override
  State<listWeb3> createState() => _listWeb2State();
}

class _listWeb2State extends State<listWeb3> {
