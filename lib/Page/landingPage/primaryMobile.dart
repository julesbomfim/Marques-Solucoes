...
class primaryLoandingMobile extends StatefulWidget {
  const primaryLoandingMobile({super.key});
  @override
  _primaryLoandingMobileState createState() => _primaryLoandingMobileState();
}

class _primaryLoandingMobileState extends State<primaryLoandingMobile>
