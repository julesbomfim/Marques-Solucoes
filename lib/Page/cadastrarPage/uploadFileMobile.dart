...
class uploadMobile extends StatefulWidget {
  //final Usua user;
  const uploadMobile({super.key, required this.user});
  final Usua user;

  @override
  State<uploadMobile> createState() => _uploadMobileState();
}

class _uploadMobileState extends State<uploadMobile> {
