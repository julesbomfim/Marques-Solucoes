...
import 'package:flutter_web/widgets/user_docs_dialog_body.dart';
import 'package:intl/intl.dart';
import 'package:pattern_formatter/numeric_formatter.dart';

class listMobile2 extends StatefulWidget {
  final List<Usua> users;

  const listMobile2({super.key, required this.users});

  @override
  State<listMobile2> createState() => _listMobile2State();
}

class _listMobile2State extends State<listMobile2> {
                                                                              ...
                                                                              child: SizedBox(
                                                                                ...
                                                                                child: ElevatedButton(
                                                                                    onPressed: () async {
                                                                                      ...
                                                                                      Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context) => const visualPage()));
