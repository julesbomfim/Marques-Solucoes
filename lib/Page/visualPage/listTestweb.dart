...
import 'package:flutter_web/utils/alerInser.dart';
...
class listWeb extends StatefulWidget {
  final List<Usua> users;

  const listWeb({super.key, required this.users});

  @override
  State<listWeb> createState() => _listWebState();
}

class _listWebState extends State<listWeb> {
                                            ...
                                            showDialog(
                                                ...
                                                builder: ((context) =>
                                                    AlertDialog(
                                                      ...
                                                      //                             IconButton(
                                                      //                               onPressed: () async {
                                                      //                                 await deleteFile(user.id, docName);
                                                      //                               },
                                                      //                               icon: const Icon(
                                                      //                                 Icons.delete,
                                                      ...
                                                      //                 if (result !=
                                                      //                     null) {
                                                      //                   // Convert picked files to a string
                                                      //                   String filesAsString = result
                                                      //                       .files
                                                      //                       .map((file) => '${file.name}:${file.bytes?.length}') // Adjust this based on your requirements
                                                      //                       .join(',');

                                                      //                   // Call the function to update user documents
                                                      //                   updateUserDocuments(
                                                      //                       user.id,
                                                      //                       filesAsString);
                                                      //                 }
