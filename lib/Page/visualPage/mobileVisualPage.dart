...
import 'package:flutter_web/Page/visualPage/listTestmobile.dart';
...
class mobileVisualPage extends StatefulWidget {
  const mobileVisualPage({super.key});

  @override
  State<mobileVisualPage> createState() => _mobileVisualPageState();
}

class _mobileVisualPageState extends State<mobileVisualPage> {
                            ...
                            builder: (context, snp) {
                              ...
                              if (snp.hasData) {
                                ...
                                return SizedBox(
                                    ...
                                    child: listMobile2(users: allusua));
                              } else {
                                return const Center(
