...
import 'package:flutter_web/usuario%202/mobile/uploadFileMobile2.dart';
...
class mobileCadastrarPage2 extends StatefulWidget {
  const mobileCadastrarPage2({super.key});

  @override
  State<mobileCadastrarPage2> createState() => _mobileCadastrarPage2State();
}

class _mobileCadastrarPage2State extends State<mobileCadastrarPage2> {
