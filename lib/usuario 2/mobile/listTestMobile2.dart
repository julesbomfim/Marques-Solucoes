...
class listMobile3 extends StatefulWidget {
  final List<Usua> users;

  const listMobile3({super.key, required this.users});

  @override
  State<listMobile3> createState() => _listMobile3State();
}

class _listMobile3State extends State<listMobile3> {
