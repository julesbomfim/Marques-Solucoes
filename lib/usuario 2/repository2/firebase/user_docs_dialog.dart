...
import 'package:flutter_web/usuario%202/controllers2/user-controller/user_controller.dart';
...
class UserDocsDialogBody2 extends StatefulWidget {
  final Usua user;

  const UserDocsDialogBody2({super.key, required this.user});

  @override
  State<UserDocsDialogBody2> createState() => _UserDocsDialogBody2State();
}

class _UserDocsDialogBody2State extends State<UserDocsDialogBody2> {
////// download
                          ...
                          children: [
                            ...
                            IconButton(
                              onPressed: () async {
                                ...
                                final response =
                                    await userController.deleteUserDoc2(
                                  user: widget.user,
                                  fileName: docName,
                                );
        ...
        ElevatedButton(
            onPressed: selectedFiles.isEmpty
                ...
                : () async {
                    ...
                    final response = await userController.insertUserDocs2(
